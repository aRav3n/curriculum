...
Please make sure that you are using the latest *LTS* version of Node, otherwise errors may occur. Open up the terminal and the folder containing your projects. Then enter the following command (you can replace my-first-react-app with any name you want), which will create and set up the project directory:
